...
export default function BookingForm() {
  ...
  return (
    <section
      id="booking"
      className="py-24 bg-gradient-to-br from-blue-700 to-blue-900"
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-blue-100 text-lg">
            Fill in the form below — we&apos;ll confirm your slot within 30
            minutes.
          </p>
        </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8 sm:p-10 space-y-6">
              ...
              <div className="rounded-2xl border-2 border-blue-100 bg-blue-50 overflow-hidden">
                ...
                <div className="divide-y divide-blue-100">
                  {[
                    ...
                    {
                      label: "Account Name",
                      value: "Eaxyconnect Global Investment Ltd.",
                    },
                  ].map(({ label, value }) => (
                    <div
                      key={label}
              ...
              <p className="text-gray-600 text-sm text-center leading-relaxed">
                Transfer the exact amount for your order, then tap below to send
                your proof of payment on WhatsApp — we&apos;ll process your
                pickup immediately.
              </p>
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="inline-flex items-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#20b95a] text-white font-bold rounded-full text-base transition-all hover:shadow-xl hover:shadow-green-500/20 hover:-translate-y-0.5"
                >
